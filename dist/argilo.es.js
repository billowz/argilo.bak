 ...
 */
class StringMatchRule extends RegMatchRule {
...
class ComplexRule extends Rule {
   ...
   * @param onErr			error callback
   */
  constructor(name, type, repeat, builder, capturable, onMatch, onErr) {
    super(name, capturable, onMatch, onErr);
    this.split = void 0;
    this.EXPECTS = void 0;
    this.builder = void 0;
...
class AndRule extends ComplexRule {
...
class OrRule extends ComplexRule {
  constructor(name, repeat, builder, capturable, onMatch, onErr) {
    super(name, 'And', repeat, builder, capturable, onMatch, onErr);
    this.startCodeIdx = void 0;
    this.type = void 0;
...
function rulesBuilder(rules) {
  return function () {
    return mapArray(rules, (r, i) => {
      if (!r) return SKIP;
      let rule = isArray(r) || isObj(r) ? mkMatch(r) : r.$rule ? r : null;
...
export { createFn, applyScope, applyNoScope, applyScopeN, applyNoScopeN, apply, applyN, fnName, bind, eq, isNull, isUndef, isNil, isBool, isNum, isStr, isFn, isInt, isPrimitive, instOf, is, isBoolean, isNumber, isString, isDate, isReg, isArray, isTypedArray, isArrayLike, isObj, isBlank, regStickySupport, regUnicodeSupport, reEscape, prototypeOfSupport, protoPropSupport, protoOf, __setProto, setProto, hasOwnProp, getOwnProp, defPropSupport, defProp, defPropValue, parsePath, formatPath, get, set, charCode, char, trim, upperFirst, upper, lower, strval, escapeStr, pad, cut, thousandSeparate, binarySeparate, octalSeparate, hexSeparate, plural, singular, FORMAT_XPREFIX, FORMAT_PLUS, FORMAT_ZERO, FORMAT_SPACE, FORMAT_SEPARATOR, FORMAT_LEFT, extendFormatter, getFormatter, vformat, format, formatter, create, doAssign, assign, assignIf, defaultAssignFilter, assignIfFilter, makeArray, STOP, eachProps, eachArray, eachObj, each, SKIP, mapArray, mapObj, map, idxOfArray, idxOfObj, idxOf, reduceArray, reduceObj, reduce, keys, values, arr2obj, makeMap, List, FnList, nextTick, clearTick, match, and, any, many, option, or, anyOne, manyOne, optionOne, MatchError, Rule, MatchRule, CharMatchRule, RegMatchRule, StringMatchRule, ComplexRule, AndRule, OrRule };
