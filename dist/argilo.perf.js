...
var     expressionArgs$1 = [ContextKeyword, ElementKeyword, BindingKeyword];
    ...
    var templ = new TemplateParser('\n            <table class="table table-hover table-striped test-data" >\n                <tbody>\n                    <tr ag-class="{\'danger\': item.id == selected}">\n                        <td class="col-md-1">{item.id}</td>\n                        <td class="col-md-4">\n                            <a ag-onclick="select(item.id)">{item.label}</a>\n                        </td>\n                        <td class="col-md-1">\n                            <a>\n                                <span class="glyphicon glyphicon-remove" aria-hidden="true" ag-onclick="delete(item.id)"></span>\n                            </a>\n                        </td>\n                        <td class="col-md-6"></td>\n                    </tr>\n                </tbody>\n            </table>\n          ');
    var TemplateParser_perf = {
        name: 'TemplateParser',
        run: function (perf, el, cb) {
...
var doc0 = Object.freeze({
        default: TemplateParser_perf
    });



    var _perfs = Object.freeze({
    	doc0: doc0
    });

    var perfs = [];
    argilo.each(_perfs, function (perf) {
      argilo.each(perf, function (p) {
        perfs.push(p);
      });
    });

    performance$1.perfs = perfs;

    argilo.ready(function () {
      performance$1.ui = argilo({
          ...
          run: function (perf) {
            ...
            if (c) {
              ...
              if (argilo.isArray(c.report)) {
                argilo.each(c.report, function (r) {
                  r.remove(true);
                });
              } else if (c.report) {
            ...
            this.runing = true;
            perf.report = perf.run(performance$1, this.refs.body, function () {
              _this.runing = false;
            });
          }
        }
...
//# sourceMappingURL=argilo.perf.js.map