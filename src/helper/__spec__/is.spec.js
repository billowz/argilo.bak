import { is, isNil, isFn, isBool, isNum, isInt, isStr, isDate, isReg, isObj, isArray, isPrimitive, isArrayLike, isBlank } from '../is'
...
const isTests = {
	...
	arrayLike: {
		is: isArrayLike,
		vals: [new Array(), [], new Array(10), [1, 2, 3], '', '   ', '123', getArgs(1, 2, 3), { length: 0 }, { length: 10, 9: undefined }]
	...
	blank: {
		is: isBlank,
		vals: ['', '     ', [], new Array(), getArgs(), { length: 0 }, null, undefined, 0, false].concat(global.Int8Array ? [new Int8Array()] : []),
		ivals: ['a', getArgs(undefined), 1, true, [1], new Array(1), {}].concat(global.Int8Array ? [new Int8Array(1)] : []),
	},
}
